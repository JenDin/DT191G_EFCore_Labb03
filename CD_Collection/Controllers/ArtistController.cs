    ...
    public class ArtistController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artist != null ? 
                          ...
                          Problem("Entity set 'DataContext.Artist'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BirthDate")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BirthDate")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
