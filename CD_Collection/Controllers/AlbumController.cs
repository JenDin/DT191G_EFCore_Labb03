...
namespace CD_Collection.Controllers
{
    public class AlbumController : Controller
    {
        ...
        {
            var dataContext = _context.Album.Include(a => a.Artist);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Tracks,ArtistId")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Tracks,ArtistId")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContext.Album'  is null.");
            }
            var album = await _context.Album.FindAsync(id);
            if (album != null)
            {
